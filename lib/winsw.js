...
// console.log({loc: 'winsw.js ~line 77', xml, config})
   ...
   */
  createExe: function(name,dir,binPath,callback) {
    ...
    let bin = binPath || p.join(__dirname,'..','bin');

    var exeOrigin = p.join(bin,'winsw','winsw.exe'),
        cfgOrigin = p.join(bin,'winsw','winsw.exe.config'),
